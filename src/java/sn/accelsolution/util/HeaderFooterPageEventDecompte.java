...
public class HeaderFooterPageEventDecompte extends PdfPageEventHelper {
    
    private Decomptep decompte;
    
    public HeaderFooterPageEventDecompte(Decomptep decompte){
...
//            header.addCell(cell2);
            ...
            Logger.getLogger(HeaderFooterPageEventDecompte.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
