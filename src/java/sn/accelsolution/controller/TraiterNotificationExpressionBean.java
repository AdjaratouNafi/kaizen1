...
@ManagedBean
@ViewScoped
public class TraiterNotificationExpressionBean implements Serializable {
    ...
    public void init() {
        ...
        notif = (Notification) session.getAttribute("myNotificationExpression");
        exp1 = ejbExpressionbesoin.find(notif.getIdExpression().getIdExpression());
    ...
    public TraiterNotificationExpressionBean() {
    ...
    public String save2() {
        ...
        try {
            ...
            if (etatExpression.equals("Rejeté")) {
                ...
                this.notif.setTraitement("Fait");
                ejbNotification.edit(this.notif);
