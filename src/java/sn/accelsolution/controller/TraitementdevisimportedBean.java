...
@ManagedBean
@ViewScoped
public class TraitementdevisimportedBean implements Serializable {
    ...
    public void init() {
        ...
        this.listDevisImportUtil = (List<DevisImportUtil>) session.getAttribute("MyDevisImported");
...
//        listDevis.add(fu);
        ...
        for (DevisImportUtil ebp : this.listDevisImportUtil) {
            if (ctr == 0) {
    ...
    public TraitementdevisimportedBean() {
