...
@ManagedBean
@ViewScoped
public class TraitementExpressionTestBean implements Serializable {
    ...
    public void init() {
        ...
        notification = (Notification) session.getAttribute("myCommandeExpression");
    ...
    public TraitementExpressionTestBean() {
...
//        } 
    ...
    public String saveTraitement() {
        ...
        try {
            ...
            cmd.setEtat(utfconvert.convertFromUTF8(this.commandeFromEdit.getEtat()));
            Commande archiveCmd = cmd;
            archiveCmd.setEtat(this.getEtatCommande());
            ejbNotification.deleteByCommande(cmd.getIdCommande());
            ...
            for (FactureUtil f : this.allFactureUtils) {
                ...
                if ((!secondListCommandes.isEmpty()) && (trouver == false)) {
                    ...
                    if (newCmd.getEtat().equals("Rejetée")) {
                        System.out.println("Je suis là !!!");
                        newCmd.setMotif(utfconvert.convertFromUTF8(this.commandeFromEdit.getMotif()));
                        ejbCommande.insertSecondCommandeExpPrim(newCmd);
