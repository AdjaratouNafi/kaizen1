...
@ManagedBean
@ViewScoped
public class NiveaudeboursserBean implements Serializable {

    @EJB
    ClientFacade ejbclient;
    @EJB
    NivodeboursserFacade ejbNiveaudeboursser;
    ...
    private Nivodeboursser nivodeboursser;
    private List listNivodebourssers;
    private List<Nivodeboursser> allNivodeboursser;
    private List<Nivodeboursser> filteredListNivodeboursser;
    ...
    public void init() {
        ...
        this.setListNivodebourssers(ejbNiveaudeboursser.findAll());
        allNivodeboursser = new ArrayList<>();
        allNivodeboursser = ejbNiveaudeboursser.findAll();       

    }

    public NiveaudeboursserBean() {
        nivodeboursser = new Nivodeboursser();

    }

    public List getListNivodebourssers() {
        return listNivodebourssers;
    }

    public void setListNivodebourssers(List listNivodebourssers) {
        this.listNivodebourssers = listNivodebourssers;
    }

    public List<Nivodeboursser> getAllNivodeboursser() {
        return allNivodeboursser;
    }

    public void setAllNivodeboursser(List<Nivodeboursser> allNivodeboursser) {
        this.allNivodeboursser = allNivodeboursser;
    }

    public List<Nivodeboursser> getFilteredListNivodeboursser() {
        return filteredListNivodeboursser;
    }

    public void setFilteredListNivodeboursser(List<Nivodeboursser> filteredListNivodeboursser) {
        this.filteredListNivodeboursser = filteredListNivodeboursser;
    }
...
//    } 
    ...
    public Nivodeboursser getNivodeboursser() {
        return nivodeboursser;
    }

    public void setNivodeboursser(Nivodeboursser nivodeboursser) {
    ...
    public String save() {
        try {
            ejbNiveaudeboursser.create(this.nivodeboursser);
            this.nivodeboursser = new Nivodeboursser();
            return "niveaudeboursser";
        } catch (Exception e) {
            return "new_nouveaudeboursser";
        }
    }
