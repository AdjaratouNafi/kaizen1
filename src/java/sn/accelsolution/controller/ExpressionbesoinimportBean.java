...
@ManagedBean
@ViewScoped
public class ExpressionbesoinimportBean implements Serializable {
    ...
    public ExpressionbesoinimportBean() {
        listEbImportUtil = new ArrayList<>();
    }
            ...
            try {
                if (uploadedFile != null) {
                    ...
                    while (iterator.hasNext()) {
                        ...
                        EbImportUtil ebp = new EbImportUtil();
                        ebp.setDesignation(designation);
                        ebp.setReference(ref);
                        ebp.setUm(um);
                        ebp.setQt(qt);

                        this.listEbImportUtil.add(ebp);
                    ...
                    session1.setAttribute("MyEbImported", this.listEbImportUtil);
                    //return "traitement_notificationDevis";
                    return "traitement_ebImported";
                }
